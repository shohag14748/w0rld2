...
var URLS = {
    bg: 'css_globe_bg.jpg',
    diffuse: 'css_globe_diffuse1.jpg',
...
function changeimage(){
    if(a<6){
        $('.world-globe-doms-container div').css('background-image','url(css_globe_diffuse' + a + '.jpg)')
//        $('.world-globe-doms-container div').animate({
//            background:'url(css_globe_diffuse4.jpg) !important'
//            background: 'red !important'
//        });
//        $('.world-globe-doms-container div').addClass('ok'+ a);
//        var b =a-1;
//        $('.world-globe-doms-container div').removeClass('ok'+b);
    }
    a++;
}
